package com.gabrielaangebrandt.funworld.OneCoutryViewActivity.view;
...
import com.gabrielaangebrandt.funworld.OneCoutryViewActivity.CountryContract;
import com.gabrielaangebrandt.funworld.OneCoutryViewActivity.presenter.CountryPresenterImpl;
...
public class CountryDetails extends AppCompatActivity implements CountryContract.CountryView {
    @BindView(R.id.countryTitle) TextView tv_name;
    @BindView(R.id.tv_population_value) TextView tv_population;
    @BindView(R.id.tv_region_value) TextView tv_region;
    @BindView(R.id.tv_area_value) TextView tv_area;
    @BindView(R.id.tv_alphacode_value)TextView tv_alphaCode;
    @BindView(R.id.tv_capital_value)TextView tv_capital;
    @BindView(R.id.tv_language_value) TextView tv_language;
    @BindView(R.id.tv_currency_value)TextView tv_currency;
    @BindView(R.id.iv_flag) ImageView imageView;
